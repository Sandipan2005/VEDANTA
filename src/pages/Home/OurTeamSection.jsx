...
const teamMembers = [
  ...
  { id: 3, name: "Saibal Trivedi", imageSrc: cofounder1 },
        ...
        <div className="w-full lg:col-span-7">
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {teamMembers.map((member) => (
              <div
                key={member.id}
                className="w-[calc(50%-8px)] sm:w-[calc(33.333%-11px)] md:w-[calc(33.333%-16px)] flex flex-col group cursor-pointer"
              >
        ...
        <article className="lg:h-auto w-full lg:col-span-5 bg-none flex flex-col justify-between p-5 md:p-10 lg:p-7">
          <div>
            ...
            <div className="space-y-4 text-[#e0e0e0] text-[14.5px] md:text-[18px] lg:text-[22px] leading-[1.6] font-light tracking-normal text-justify">
              <p>
                At Vedanta Legal Associates, we pride ourselves on having a
                strong, unified team of lawyers, junior associates, law clerks,
                and support staff working together with integrity and dedication.
                Our partners and senior lawyers bring rich experience from
                multiple domains, enabling us to deliver balanced and effective
                legal solutions. We believe in a collaborative approach where
                the entire team works cohesively to meet the unique requirements
                of each case. This teamwork allows us to serve our clients with
                greater efficiency and depth, always guided by our core
                philosophy of "Balance in Justice".
              </p>
            </div>
          </div>
          ...
          <div className="mt-1">
            ...
            <div className="grid grid-cols-3 gap-4 border-t border-gray-700/50 pt-3 mb-7.5">
              <div className="text-center flex flex-col items-center">
                <span className="text-2xl md:text-2xl font-bold text-[#C4A661]">
                  200+
                </span>
                <span className="text-[11px] md:text-xs text-gray-400 uppercase tracking-widest mt-1">
                  Lawyers
                </span>
              </div>
            ...
            <div className="flex justify-center lg:justify-start">
              <Link
                to="/team"
                className="w-full lg:w-auto bg-[#C4A661] text-black px-8 py-2 text-sm md:text-[15px] flex items-center justify-center gap-3 hover:bg-[#b09557] transition-colors group font-bold tracking-widest uppercase whitespace-nowrap"
              >
                View Team Members
