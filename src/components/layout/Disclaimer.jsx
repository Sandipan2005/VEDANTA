...
const Disclaimer = () => {
  ...
  useEffect(() => {
    const hasAgreed = sessionStorage.getItem("agree");
    if (hasAgreed !== "yes") {
      setShow(true);
    }
  }, []);
  ...
  return (
    <div className="overlay">
      <div className="disclaimer">
        ...
        <ol>
          <li>No advertisement or solicitation has been made.</li>
          <li>You are visiting this website voluntarily.</li>
          <li>Information is only for general purposes.</li>
        </ol>
